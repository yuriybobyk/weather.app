...
const Search = () => {
    ...
    const getForecast =
        (city: optionType) => {
            fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${city.lat}&lon=${city.lon}&units=metric&appid=9fe532a04608b29121d76ffda602a586`).then((res => res.json().then((data) => setForecast(data))))
